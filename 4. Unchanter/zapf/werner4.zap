...
?L27:	CALL2 GOTO,RM >STACK
	...
	RTRUE
?L1:	ICALL2 NOT-POSSIBLE,STR?153
	RTRUE
...
?L3:	FSET? PRSO,CONTBIT /?L4
	CALL2 NOT-POSSIBLE,STR?154 >STACK
	RSTACK
...
?L4:	ICALL2 NOT-POSSIBLE,STR?158
	RTRUE
...
?L1:	FSET? PRSI,CONTBIT \?L4
	FSET? PRSI,SURFACEBIT \?L3
?L4:	ICALL2 NOT-POSSIBLE,STR?159
	RTRUE
...
?L3:	RETURN W
	...
	RTRUE
?L1:	ICALL2 NOT-POSSIBLE,STR?160
	RTRUE
...
?L6:	PRINTI "You switch off "
	...
	ICALL2 POINTLESS,STR?167
	RTRUE
?L3:	ICALL2 NOT-POSSIBLE,STR?166
	RTRUE
...
?L1:	FSET? PRSI,PERSONBIT \?L6
	ICALL2 YOU-MASHER,PRSI
	RTRUE
?L6:	ICALL POINTLESS,STR?167,0,1
	RTRUE
...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?173 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 NOT-POSSIBLE,STR?179 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?180 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?181 >STACK
	RSTACK
...
?L3:	EQUAL? PRSA,V?WORTA \FALSE
	EQUAL? 11-CURRENT-SPELL,45 \FALSE
	ZERO? 21-WORTA-ME-FLAG /?L7
	PRINT MESSAGE-110
	CRLF
	SET '11-CURRENT-SPELL,0
	RTRUE
?L7:	PRINT MESSAGE-109
	CRLF
	MOVE 48-WART,WINNER
	SET '21-WORTA-ME-FLAG,1
	SET '11-CURRENT-SPELL,0
	RTRUE
...
?L1:	PRINT SYSMESSAGE-007
	...
	RTRUE
?L1:	PRINTR "Talking to yourself, huh?"
	...
	.FUNCT V-BRENWYN
	EQUAL? 11-CURRENT-SPELL,41 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-103
	CRLF
	RTRUE

	.FUNCT V-BRRRODVEJ
	EQUAL? 11-CURRENT-SPELL,42 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-104
	CRLF
	RTRUE

	.FUNCT V-REPHLEX
	EQUAL? 11-CURRENT-SPELL,43 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	EQUAL? HERE,57-SECRET-CHAMBER \?L10
	SET 'PRSO,KVILL
	ICALL1 KVILL-F
	EQUAL? HERE,57-SECRET-CHAMBER /FALSE
?L10:	PRINT MESSAGE-088
	CRLF
	RTRUE

	.FUNCT V-REVHOL
	EQUAL? 11-CURRENT-SPELL,44 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-105
	CRLF
	RTRUE

	.FUNCT V-TUBORG
	EQUAL? 11-CURRENT-SPELL,46 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-106
	CRLF
	RTRUE

	.FUNCT V-WORTA
	EQUAL? 11-CURRENT-SPELL,45 /?L1
	PRINT MESSAGE-102
	CRLF
	RTRUE
?L1:	PRINT SYSMESSAGE-008
	...
	.FUNCT V-FILL-IN
	CALL PERFORM,V?FILL,PRSI,PRSO >STACK
	RSTACK
...
?L0:	SET 'Q,0
	...
	ICALL LEFT-LINE,3,STR?183
	ICALL RIGHT-LINE,3,STR?184,13
...
?L2:	ZERO? Q /?L0
	...
	CURSET 1,1
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?185,16
	CURSET 3,1
	ICALL1 INVERSE-LINE
	ICALL LEFT-LINE,3,STR?183
	ICALL RIGHT-LINE,3,STR?186,17
	CURSET 2,1
	ICALL1 INVERSE-LINE
	HLIGHT H-BOLD
...
?L4:	CLEAR -1
	...
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?185,16
	ICALL LEFT-LINE,2,STR?187
	ICALL RIGHT-LINE,2,STR?188,12
	ZERO? THIRD /FALSE
	ICALL LEFT-LINE,3,STR?189
	CALL RIGHT-LINE,3,STR?190,16 >STACK
	RSTACK
...
?L4:	PRINT STR
	...
	.FUNCT CASTLE-GATE-EXIT
	PRINT MESSAGE-047
	CRLF
	CRLF
	ZERO? SCORE-ENTER-CASTLE-FLAG \?L1
	ADD SCORE,10 >SCORE
	SET 'SCORE-ENTER-CASTLE-FLAG,1
?L1:	RETURN 17-ENTRANCE-HALL
	...
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-017
	CRLF
	MOVE 04-NEWSPAPER,HERE
	SET '13-BIN-FLAG,1
	ICALL2 THIS-IS-IT,04-NEWSPAPER
	RTRUE

	.FUNCT HIGH-SCHOOL-F
	EQUAL? PRSA,V?EXAMINE \FALSE
	CALL2 HELD?,01-BINOCULARS >STACK
	ZERO? STACK /?L3
	PRINT MESSAGE-046
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-045
	CRLF
	RTRUE

	.FUNCT DUNGEON-OF-DESPAIR-F,RARG
	EQUAL? RARG,M-END \FALSE
	ZERO? 15-DUNGEON-FLAG \FALSE
	CRLF
	PRINT MESSAGE-040
	CRLF
	PRINT MESSAGE-041
	CRLF
	SET '15-DUNGEON-FLAG,1
	RTRUE

	.FUNCT NE-TOWER-BASE-EXIT
	ZERO? 18-JEFF-MINTER-FLAG /?L1
	RETURN 61-MINTER-ROOM
?L1:	RETURN 27-JEFF-MINTERS-ROOM

	.FUNCT JEFF-MINTERS-ROOM-F,RARG
	EQUAL? RARG,M-END \FALSE
	ZERO? 17-COMPANY-FLAG /FALSE
	PRINT MESSAGE-061
	CRLF
	CRLF
	SET '18-JEFF-MINTER-FLAG,1
	ICALL2 GOTO,61-MINTER-ROOM
...
?L1:	PRINT SYSMESSAGE-007
	...
	RTRUE
?L3:	LOC 22-RABBIT >STACK
	EQUAL? STACK,HERE \?L5
	LOC 25-WELL >STACK
	EQUAL? STACK,HERE /?L5
	ICALL2 JIGS-UP,MESSAGE-071
	RTRUE
?L5:	LOC 22-RABBIT >STACK
	EQUAL? STACK,HERE /FALSE
	PRINT MESSAGE-073
	CRLF
	RTRUE
	...
	.FUNCT MIRROR-F
	EQUAL? PRSA,V?TOUCH,V?RUB \FALSE
	PRINT MESSAGE-077
	CRLF
	CRLF
	EQUAL? HERE,30-MIRROR-ROOM \?L3
	ZERO? SCORE-ENTER-TOILET-FLAG \?L5
	ADD SCORE,10 >SCORE
	SET 'SCORE-ENTER-TOILET-FLAG,1
?L5:	CALL2 GOTO,56-TOILET >STACK
	RSTACK
?L3:	CALL2 GOTO,30-MIRROR-ROOM >STACK
	RSTACK

	.FUNCT SMALL-ROOM-BRICK-EXIT
	LOC 20-LARGE-HOLE >STACK
	EQUAL? STACK,HERE \?L1
	RETURN 57-SECRET-CHAMBER
?L1:	PRINT SYSMESSAGE-007
	CRLF
	RFALSE
...
?L3:	PRINT MESSAGE-068
	...
	CRLF
	RTRUE
?L3:	EQUAL? PRSA,V?TUBORG \FALSE
	EQUAL? 11-CURRENT-SPELL,46 \FALSE
	ZERO? 14-FAN-FLAG \?L9
	PRINT MESSAGE-065
	CRLF
	SET '14-FAN-FLAG,1
?L9:	SET '11-CURRENT-SPELL,0
	MOVE 12-UNSTEADY-FAN,HERE
	RTRUE

	.FUNCT CUPBOARD-F
	EQUAL? PRSA,V?OPEN \FALSE
	LOC 13-ROCK-FAN >STACK
	EQUAL? STACK,HERE \?L3
	PRINT MESSAGE-054
	CRLF
	MOVE 13-ROCK-FAN,LOCAL-GLOBALS
	SET '16-GRUE-COUNTER,2
	SET '19-SOBER-FAN-FLAG,0
	RTRUE
?L3:	ZERO? 16-GRUE-COUNTER \?L5
	PRINT MESSAGE-052
	CRLF
	SET '16-GRUE-COUNTER,1
	RTRUE
?L5:	EQUAL? 16-GRUE-COUNTER,1 \?L6
	PRINT MESSAGE-053
	CRLF
	RTRUE
?L6:	EQUAL? 16-GRUE-COUNTER,2 \?L7
	PRINT MESSAGE-055
	CRLF
	MOVE 11-CERISE-SCROLL,WINNER
	ZERO? SCORE-BRRRODVEJ-FLAG \?L8
	ADD SCORE,10 >SCORE
	SET 'SCORE-BRRRODVEJ-FLAG,1
?L8:	SET '16-GRUE-COUNTER,3
	RTRUE
?L7:	EQUAL? 16-GRUE-COUNTER,3 \FALSE
	PRINT MESSAGE-056
	CRLF
	RTRUE

	.FUNCT WELL-BOTTOM-F,RARG
	EQUAL? RARG,M-END \FALSE
	LOC 23-KILLER-RABBIT >STACK
	EQUAL? STACK,HERE \FALSE
	CRLF
	ICALL2 JIGS-UP,MESSAGE-099
	RTRUE

	.FUNCT ROCK-CLUB-F,RARG
	EQUAL? RARG,M-END \FALSE
	CRLF
	PRINT MESSAGE-097
	CRLF
	CRLF
	ICALL2 GOTO,44-COURTYARD
	RTRUE

	.FUNCT KIT-F
	EQUAL? PRSA,V?EXAMINE \FALSE
	ZERO? 12-YEAST-FLAG /?L3
	PRINT MESSAGE-016
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-015
	CRLF
	MOVE 05-YEAST-SCROLL,HERE
	RTRUE

	.FUNCT PETROL-F
	EQUAL? PRSA,V?TAKE,V?PUMP \FALSE
	CALL2 HELD?,27-BUCKET >STACK
	ZERO? STACK /?L3
	PRINT MESSAGE-008
	CRLF
	...
	RTRUE
?L3:	CALL2 HELD?,28-BUCKET-WITH-PETROL >STACK
	ZERO? STACK /?L6
	PRINT MESSAGE-009
	CRLF
	RTRUE
?L6:	PRINT MESSAGE-010
	CRLF
	RTRUE

	.FUNCT KVILL-F
	EQUAL? PRSA,V?EXAMINE \?L1
	ZERO? 20-KVILL-FLAG /?L36
	PRINT MESSAGE-092
	CRLF
	RTRUE
?L36:	PRINT MESSAGE-091
	CRLF
	RTRUE
?L1:	EQUAL? PRSA,V?WORTA \?L8
	EQUAL? 11-CURRENT-SPELL,45 \?L8
	ZERO? 20-KVILL-FLAG /?L37
	PRINT MESSAGE-094
	CRLF
	JUMP ?L12
?L37:	PRINT MESSAGE-093
	CRLF
	SET '20-KVILL-FLAG,1
?L12:	SET '11-CURRENT-SPELL,0
	RTRUE
?L8:	EQUAL? PRSA,V?TELL \?L15
	SET 'WINNER,PRSO
	RTRUE
?L15:	EQUAL? WINNER,KVILL /?L20
	EQUAL? PRSO,KVILL \?L24
?L20:	EQUAL? PRSA,V?HELLO /?L23
	EQUAL? PRSI,HELLO \?L21
?L23:	PRINT MESSAGE-115
	CRLF
	RTRUE
?L21:	EQUAL? WINNER,KVILL \?L24
	PRINTR "You are plainly ignored."
?L24:	EQUAL? PRSA,V?REPHLEX \FALSE
	EQUAL? 11-CURRENT-SPELL,43 \FALSE
	ZERO? 20-KVILL-FLAG /?L29
	ZERO? SCORE-KVILL-FLAG \?L31
	ADD SCORE,10 >SCORE
	SET 'SCORE-KVILL-FLAG,1
?L31:	ICALL2 JIGS-UP,MESSAGE-090
	RTRUE
?L29:	PRINT MESSAGE-089
	CRLF
	SET '11-CURRENT-SPELL,0
	RTRUE
	...
	.FUNCT NEWSPAPER-F
	EQUAL? PRSA,V?TAKE \?L3
	EQUAL? HERE,16-INSIDE-FARMHOUSE \?L3
	ZERO? 12-YEAST-FLAG \?L3
	ICALL2 JIGS-UP,MESSAGE-050
	RTRUE
?L3:	EQUAL? PRSA,V?READ \?L7
	ICALL1 FIXED-FONT-ON
	PRINT MESSAGE-014
	CRLF
	ICALL1 FIXED-FONT-OFF
	RTRUE
?L7:	EQUAL? PRSA,V?REPLACE \?L10
	EQUAL? PRSI,05-YEAST-SCROLL,0 /?L12
	CALL2 HELD?,05-YEAST-SCROLL >STACK
	ZERO? STACK /?L10
?L12:	ICALL2 JIGS-UP,MESSAGE-058
	RTRUE
?L10:	EQUAL? PRSA,V?INSERT \FALSE
	EQUAL? PRSI,DISTILLATION-KIT,0 /?L16
	CALL2 HELD?,04-NEWSPAPER >STACK
	ZERO? STACK /FALSE
?L16:	PRINT MESSAGE-057
	CRLF
	MOVE 04-NEWSPAPER,HERE
	FSET 04-NEWSPAPER,NDESCBIT
	FCLEAR 05-YEAST-SCROLL,NDESCBIT
	MOVE 05-YEAST-SCROLL,WINNER
	ZERO? SCORE-BRENWYN-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-BRENWYN-FLAG,1
	RTRUE

	.FUNCT YEAST-SCROLL-F
	EQUAL? PRSA,V?TAKE \?L3
	EQUAL? HERE,16-INSIDE-FARMHOUSE \?L3
	ZERO? 12-YEAST-FLAG \?L3
	ICALL2 JIGS-UP,MESSAGE-049
	RTRUE
?L3:	EQUAL? PRSA,V?REPLACE \?L7
	EQUAL? PRSI,04-NEWSPAPER,0 /?L9
	CALL2 HELD?,04-NEWSPAPER >STACK
	ZERO? STACK /?L7
?L9:	PRINT MESSAGE-057
	CRLF
	MOVE 04-NEWSPAPER,HERE
	FSET 04-NEWSPAPER,NDESCBIT
	FCLEAR 05-YEAST-SCROLL,NDESCBIT
	...
	SET 'SCORE-BRENWYN-FLAG,1
	RTRUE
?L7:	EQUAL? PRSA,V?INSERT \?L14
	EQUAL? PRSI,DISTILLATION-KIT,0 /?L16
	CALL2 HELD?,05-YEAST-SCROLL >STACK
	ZERO? STACK /?L14
?L16:	ICALL2 JIGS-UP,MESSAGE-058
	RTRUE
?L14:	EQUAL? PRSA,V?XEROX \FALSE
	...
	.FUNCT MACHINE-F
	EQUAL? PRSA,V?FILL \FALSE
	EQUAL? PRSI,0,28-BUCKET-WITH-PETROL /?L3
	CALL2 HELD?,PRSI >STACK
	ZERO? STACK /FALSE
?L3:	PRINT MESSAGE-079
	CRLF
	...
	.FUNCT TOWEL-F
	EQUAL? PRSA,V?WEAR,V?WRAP \FALSE
	ZERO? PRSI /?L3
	EQUAL? PRSI,HEAD \FALSE
?L3:	PRINT MESSAGE-100
	CRLF
	MOVE 09-TOWEL,LOCAL-GLOBALS
	MOVE 10-TOWEL-AROUND-HEAD,WINNER
	RTRUE

	.FUNCT TOWEL-AROUND-HEAD-F
	EQUAL? PRSA,V?UNWEAR,V?DROP \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /FALSE
	PRINT MESSAGE-101
	CRLF
	...
	MOVE 09-TOWEL,HERE
?L3:	ICALL2 THIS-IS-IT,09-TOWEL
	RTRUE

	.FUNCT CERISE-SCROLL-F
	EQUAL? PRSA,V?XEROX \FALSE
	FSET? PRSO,SCROLLBIT \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /FALSE
	PRINT MESSAGE-005
	...
	.FUNCT UNSTEADY-FAN-F
	EQUAL? PRSA,V?WORTA \?L1
	EQUAL? 11-CURRENT-SPELL,45 \?L1
	PRINT MESSAGE-113
	CRLF
	SET '11-CURRENT-SPELL,0
	RTRUE
?L1:	EQUAL? PRSA,V?TELL \?L4
	SET 'WINNER,PRSO
	RTRUE
?L4:	EQUAL? WINNER,12-UNSTEADY-FAN /?L9
	EQUAL? PRSO,12-UNSTEADY-FAN \?L13
?L9:	EQUAL? PRSA,V?HELLO /?L12
	EQUAL? PRSI,HELLO \?L10
?L12:	PRINT MESSAGE-116
	CRLF
	RTRUE
?L10:	EQUAL? WINNER,12-UNSTEADY-FAN \?L13
	PRINTR "You are plainly ignored."
?L13:	EQUAL? PRSA,V?BRENWYN \FALSE
	EQUAL? 11-CURRENT-SPELL,41 \FALSE
	PRINT MESSAGE-066
	CRLF
	MOVE 12-UNSTEADY-FAN,LOCAL-GLOBALS
	MOVE 13-ROCK-FAN,HERE
	SET '19-SOBER-FAN-FLAG,1
	SET '11-CURRENT-SPELL,0
	RTRUE
...
?L1:	EQUAL? PRSA,V?TELL \?L4
	SET 'WINNER,PRSO
	RTRUE
?L4:	EQUAL? WINNER,13-ROCK-FAN /?L9
	EQUAL? PRSO,13-ROCK-FAN \FALSE
?L9:	EQUAL? PRSA,V?HELLO /?L12
	EQUAL? PRSI,HELLO \?L10
?L12:	PRINT MESSAGE-116
	CRLF
	RTRUE
?L10:	EQUAL? WINNER,13-ROCK-FAN \FALSE
	PRINTR "You are plainly ignored."

	.FUNCT WIG-F
	EQUAL? PRSA,V?WEAR \?L4
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L1
	FSET? PRSO,WORNBIT \?L1
...
?L1:	EQUAL? PRSA,V?WEAR \?L4
	...
	FSET PRSO,WORNBIT
	RTRUE
?L4:	EQUAL? PRSA,V?UNWEAR \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L7
	FSET? PRSO,WORNBIT /?L7
...
?L7:	EQUAL? PRSA,V?UNWEAR \FALSE
	...
	.FUNCT TOAD-F
	EQUAL? PRSA,V?REVHOL \?L8
	EQUAL? 11-CURRENT-SPELL,44 \?L8
	PRINT MESSAGE-085
	CRLF
	CRLF
	FSET? 15-WIG,WORNBIT \?L3
	FSET? 16-DRESS,WORNBIT \?L3
	PRINT MESSAGE-087
	CRLF
	MOVE 17-TOAD,LOCAL-GLOBALS
	MOVE 33-COLOGNE-SOAKED-SCROLL,WINNER
	ZERO? SCORE-REPHLEX-FLAG \?L5
	ADD SCORE,10 >SCORE
	SET 'SCORE-REPHLEX-FLAG,1
?L5:	SET '11-CURRENT-SPELL,0
	RTRUE
?L3:	ICALL2 JIGS-UP,MESSAGE-086
	RTRUE
?L8:	EQUAL? PRSA,V?KISS \FALSE
	PRINT MESSAGE-107
	CRLF
	RTRUE
	...
	EQUAL? PRSI,35-COMPANY \?L1
	PRINT MESSAGE-060
	CRLF
	SET '17-COMPANY-FLAG,1
	RTRUE
?L1:	EQUAL? HERE,31-SMALL-ROOM \?L15
	CALL2 HELD?,21-PHOTO >STACK
	ZERO? STACK /?L4
	LOC 35-COMPANY >STACK
	EQUAL? STACK,HERE \?L4
	EQUAL? PRSA,V?DROP /?L6
	EQUAL? PRSA,V?GIVE \?L4
	EQUAL? PRSI,35-COMPANY \?L4
?L6:	PRINT MESSAGE-063
	CRLF
	...
	SET '17-COMPANY-FLAG,0
	ZERO? SCORE-LARGE-HOLE-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-LARGE-HOLE-FLAG,1
	RTRUE
?L4:	EQUAL? HERE,31-SMALL-ROOM /FALSE
?L15:	CALL2 HELD?,21-PHOTO >STACK
	ZERO? STACK /FALSE
	LOC 35-COMPANY >STACK
	EQUAL? STACK,HERE \FALSE
	EQUAL? PRSA,V?DROP /?L13
	EQUAL? PRSA,V?GIVE \FALSE
	EQUAL? PRSI,35-COMPANY \FALSE
?L13:	PRINT MESSAGE-062
	CRLF
	MOVE 21-PHOTO,LOCAL-GLOBALS
	MOVE 35-COMPANY,LOCAL-GLOBALS
	MOVE 36-UNCONSCIOUS-PERSONS,HERE
	...
	.FUNCT BOX-F
	EQUAL? PRSA,V?EXAMINE \?L1
	FSET? PRSO,NDESCBIT \?L1
	PRINTR "You don't see that here."
?L1:	EQUAL? PRSA,V?BUY \?L4
	LOC 26-HONEST-JOHN >STACK
	EQUAL? STACK,HERE \?L4
	CALL2 HELD?,08-COIN >STACK
	ZERO? STACK /?L4
	PRINT MESSAGE-095
...
?L1:	EQUAL? PRSA,V?TELL \?L4
	SET 'WINNER,PRSO
	RTRUE
?L4:	EQUAL? WINNER,26-HONEST-JOHN /?L9
	EQUAL? PRSO,26-HONEST-JOHN \FALSE
?L9:	EQUAL? PRSA,V?HELLO /?L12
	EQUAL? PRSI,HELLO \?L10
?L12:	PRINT MESSAGE-108
	CRLF
	RTRUE
?L10:	EQUAL? WINNER,26-HONEST-JOHN \FALSE
	PRINTR "You are plainly ignored."

	.FUNCT BUCKET-F
	EQUAL? PRSA,V?FILL \?L5
	EQUAL? HERE,55-PETROL-STATION \?L3
	ICALL PERFORM,V?TAKE,PETROL
	JUMP ?L5
?L3:	EQUAL? PRSO,28-BUCKET-WITH-PETROL \?L5
	EQUAL? HERE,39-SW-TOWER \?L5
	LOC 06-MACHINE >STACK
	EQUAL? STACK,HERE \?L5
	ICALL PERFORM,V?FILL,06-MACHINE
	RTRUE
?L5:	EQUAL? PRSA,V?INSERT \FALSE
	EQUAL? PRSO,28-BUCKET-WITH-PETROL \FALSE
	EQUAL? PRSI,06-MACHINE \FALSE
	EQUAL? HERE,39-SW-TOWER \FALSE
	LOC 06-MACHINE >STACK
	EQUAL? STACK,HERE \FALSE
	ICALL PERFORM,V?FILL,06-MACHINE
	RTRUE
	...
	.FUNCT MOTOR-F
	EQUAL? PRSA,V?INSERT \FALSE
	CALL2 HELD?,29-MOTOR >STACK
	ZERO? STACK /FALSE
	EQUAL? PRSI,18-FLOYD \FALSE
	PRINT MESSAGE-078
	CRLF
	MOVE 29-MOTOR,LOCAL-GLOBALS
	MOVE 19-PINK-SCROLL,WINNER
	ZERO? SCORE-REVHOL-FLAG \?L3
	ADD SCORE,10 >SCORE
	SET 'SCORE-REVHOL-FLAG,1
?L3:	MOVE 18-FLOYD,LOCAL-GLOBALS
	RTRUE

	.FUNCT BLANK-SCROLL-F
	EQUAL? PRSA,V?WRITE \FALSE
	EQUAL? PRSO,30-BLANK-SCROLL \FALSE
	EQUAL? PRSI,31-PENCIL \FALSE
	PRINT MESSAGE-075
	CRLF
	MOVE 30-BLANK-SCROLL,LOCAL-GLOBALS
	MOVE 32-NEW-SCROLL,WINNER
	ZERO? SCORE-TUBORG-FLAG \?L3
	ADD SCORE,10 >SCORE
	SET 'SCORE-TUBORG-FLAG,1
?L3:	MOVE 31-PENCIL,LOCAL-GLOBALS
	RTRUE
...
?L1:	EQUAL? PRSA,V?TELL \?L4
	SET 'WINNER,PRSO
	RTRUE
?L4:	EQUAL? WINNER,34-PERSONS /?L9
	EQUAL? PRSO,34-PERSONS \?L13
?L9:	EQUAL? PRSA,V?HELLO /?L12
	EQUAL? PRSI,HELLO \?L10
?L12:	PRINT MESSAGE-117
	CRLF
	RTRUE
?L10:	EQUAL? WINNER,34-PERSONS \?L13
	PRINTR "You are plainly ignored."
?L13:	EQUAL? PRSA,V?BRRRODVEJ \FALSE
	EQUAL? 11-CURRENT-SPELL,42 \FALSE
	PRINT MESSAGE-059
	CRLF
	...
	ZERO? 17-COMPANY-FLAG /?L3
	PRINT MESSAGE-038
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-037
	CRLF
	RTRUE
?L5:	EQUAL? PRSA,V?WORTA \?L7
	EQUAL? 11-CURRENT-SPELL,45 \?L7
	PRINT MESSAGE-112
	CRLF
	SET '11-CURRENT-SPELL,0
	RTRUE
?L7:	EQUAL? PRSA,V?TELL \?L10
	SET 'WINNER,PRSO
	RTRUE
?L10:	EQUAL? WINNER,35-COMPANY /?L15
	EQUAL? PRSO,35-COMPANY \FALSE
?L15:	EQUAL? PRSA,V?HELLO /?L18
	EQUAL? PRSI,HELLO \?L16
?L18:	PRINT MESSAGE-117
	CRLF
	RTRUE
?L16:	EQUAL? WINNER,35-COMPANY \FALSE
	PRINTR "You are plainly ignored."

	.FUNCT UNCONSCIOUS-PERSONS-F
	EQUAL? PRSA,V?WORTA \FALSE
	EQUAL? 11-CURRENT-SPELL,45 \FALSE
	PRINT MESSAGE-112
	CRLF
	SET '11-CURRENT-SPELL,0
	...
	.FUNCT XEROX-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?XEROX,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-007
	CRLF
	RTRUE
	...
	.FUNCT BRENWYN-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?BRENWYN,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,41
	RTRUE

	.FUNCT BRRRODVEJ-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?BRRRODVEJ,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,42
	RTRUE

	.FUNCT REPHLEX-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?REPHLEX,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,43
	RTRUE

	.FUNCT REVHOL-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?REVHOL,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,44
	RTRUE

	.FUNCT WORTA-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?WORTA,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,45
	RTRUE

	.FUNCT TUBORG-F
	EQUAL? PRSA,V?CAST \?L1
	ICALL PERFORM,V?TUBORG,PRSI
	RTRUE
?L1:	EQUAL? PRSA,V?LEARN \FALSE
	PRINT MESSAGE-006
	CRLF
	SET '11-CURRENT-SPELL,46
	RTRUE
	...
	LOC 25-WELL >STACK
	EQUAL? STACK,HERE \?L1
	RETURN 40-WELL-BOTTOM
?L1:	EQUAL? HERE,20-BARE-TOWER-ROOM \?L3
	RETURN 19-NW-TOWER-BASE
?L3:	EQUAL? HERE,22-EW-CORRIDOR \?L4
	RETURN 23-DUNGEON-OF-DESPAIR
?L4:	EQUAL? HERE,27-JEFF-MINTERS-ROOM \?L5
	RETURN 26-NE-TOWER-BASE
?L5:	EQUAL? HERE,39-SW-TOWER \?L6
	RETURN 38-SW-TOWER-BASE
?L6:	EQUAL? HERE,61-MINTER-ROOM \?L7
	RETURN 26-NE-TOWER-BASE
?L7:	EQUAL? HERE,34-BEDROOM \?L8
	RETURN 33-SE-TOWER-BASE
?L8:	PRINT SYSMESSAGE-007
	CRLF
	RFALSE

	.FUNCT I-EVERY-TURN
	ZERO? 19-SOBER-FAN-FLAG /?L1
	LOC 13-ROCK-FAN >STACK
	EQUAL? STACK,HERE /?L1
	CRLF
	PRINT MESSAGE-067
...
?L1:	RANDOM 100 >STACK
	GRTR? STACK,2 /?L4
	EQUAL? HERE,40-WELL-BOTTOM \?L4
	CRLF
	PRINT MESSAGE-098
	CRLF
	RTRUE
?L4:	ZERO? 17-COMPANY-FLAG /?L7
	LOC 35-COMPANY >STACK
	EQUAL? STACK,HERE /?L7
	CRLF
	PRINT MESSAGE-064
	...
	MOVE 35-COMPANY,HERE
	RTRUE
?L7:	LOC 07-INFERNAL-MACHINE >STACK
	EQUAL? STACK,HERE \FALSE
	LOC 02-PIGGY-BANK >STACK
	EQUAL? STACK,HERE \FALSE
	CALL2 HELD?,02-PIGGY-BANK >STACK
	ZERO? STACK \FALSE
	CRLF
	PRINT MESSAGE-080
	CRLF
	...
	MOVE 08-COIN,HERE
	ZERO? SCORE-GET-COIN-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-GET-COIN-FLAG,1
	RTRUE
