...
?L27:	CALL2 GOTO,RM >STACK
	...
	RTRUE
?L1:	ICALL2 NOT-POSSIBLE,STR?150
	RTRUE
...
?L3:	FSET? PRSO,CONTBIT /?L4
	CALL2 NOT-POSSIBLE,STR?151 >STACK
	RSTACK
...
?L4:	ICALL2 NOT-POSSIBLE,STR?155
	RTRUE
...
?L1:	FSET? PRSI,CONTBIT \?L4
	FSET? PRSI,SURFACEBIT \?L3
?L4:	ICALL2 NOT-POSSIBLE,STR?156
	RTRUE
...
?L3:	RETURN W
	...
	RTRUE
?L1:	ICALL2 NOT-POSSIBLE,STR?157
	RTRUE
...
?L6:	PRINTI "You switch off "
	...
	ICALL2 POINTLESS,STR?164
	RTRUE
?L3:	ICALL2 NOT-POSSIBLE,STR?163
	RTRUE
...
?L1:	FSET? PRSI,PERSONBIT \?L6
	ICALL2 YOU-MASHER,PRSI
	RTRUE
?L6:	ICALL POINTLESS,STR?164,0,1
	RTRUE
...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?170 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 NOT-POSSIBLE,STR?176 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?177 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?178 >STACK
	RSTACK
...
?L1:	PRINT SYSMESSAGE-007
	...
	.FUNCT V-DIG
	PRINTR "You lack the proper tools."

	.FUNCT V-SLEEP
	PRINTR "You aren't feeling especially sleepy."

	.FUNCT V-LOOK-UP
	PRINTR "You see nothing special."

	.FUNCT V-TOUCH
	PRINTR "You feel nothing special."

	.FUNCT V-TOUCH-WITH
	PRINTR "Nothing special happens."
	...
	.FUNCT V-ATTACK
	ZERO? GAME$005fVERSION$005fCLASSIC \?L3
	LESS? HIT-COUNTER,1 /?L1
?L3:	ICALL2 JIGS-UP,MESSAGE-049
	RTRUE
?L1:	PRINTI "As you raise your hand to strike, the now-familiar troll appears. His menacing presence makes you reconsider."
	CRLF
	INC 'HIT-COUNTER
	RTRUE

	.FUNCT V-KISS
	PRINTR "Keep your mind on the game."

	.FUNCT V-HELLO
	PRINTR "You are plainly ignored."
...
?L0:	SET 'Q,0
	...
	ICALL LEFT-LINE,3,STR?179
	ICALL RIGHT-LINE,3,STR?180,13
...
?L2:	ZERO? Q /?L0
	...
	CURSET 1,1
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?181,16
	CURSET 3,1
	ICALL1 INVERSE-LINE
	ICALL LEFT-LINE,3,STR?179
	ICALL RIGHT-LINE,3,STR?182,17
	CURSET 2,1
	ICALL1 INVERSE-LINE
	HLIGHT H-BOLD
...
?L4:	CLEAR -1
	...
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?181,16
	ICALL LEFT-LINE,2,STR?183
	ICALL RIGHT-LINE,2,STR?184,12
	ZERO? THIRD /FALSE
	ICALL LEFT-LINE,3,STR?185
	CALL RIGHT-LINE,3,STR?186,16 >STACK
	RSTACK
...
?L1:	CALL1 STANDARD-F >STACK
	...
	.FUNCT GREAT-HALL-NE-IN-EXIT
	LOC 21-PLASTIC-GNOME >STACK
	EQUAL? STACK,HERE \?L1
	RETURN 46-TOADSTOOL
?L1:	PRINT MESSAGE-036
	CRLF
	RFALSE

	.FUNCT GREAT-HALL-NE-UP-EXIT
	LOC 33-LADDER-AGAINST-TOADSTOOL >STACK
	EQUAL? STACK,HERE \?L1
	RETURN 12-ON-TOADSTOOL
?L1:	PRINT SYSMESSAGE-007
	CRLF
	RFALSE
...
?L1:	EQUAL? PRSA,V?EXAMINE \?L8
	...
	CRLF
	RTRUE
?L6:	PRINT MESSAGE-036
	CRLF
	RTRUE
?L8:	CALL1 STANDARD-F >STACK
	RSTACK
	...
	CRLF
	RTRUE
?L1:	EQUAL? PRSA,V?KISS \?L8
	EQUAL? HERE,05-GREAT-HALL-NE \?L6
	PRINT MESSAGE-099
	CRLF
	RTRUE
?L6:	PRINT MESSAGE-100
	CRLF
	RTRUE
?L8:	CALL1 STANDARD-F >STACK
	RSTACK
...
?L1:	CALL1 STANDARD-F >STACK
	...
	.FUNCT OLD-FARM-WEST-EXIT
	FSET? 09-PAPERBAG,WORNBIT \?L1
	ZERO? 19-FARMHOUSE-FLAG \?L1
	SET '07-PAPERBAG-COUNTER,5
?L1:	RETURN 19-FARMHOUSE

	.FUNCT OLD-FARM-DOWN-EXIT
	ZERO? 18-WELL-FLAG /?L1
	PRINT MESSAGE-057
	CRLF
	CRLF
	SET '06-WELL2-COUNTER,1
	RETURN 23-TOOLSHED
?L1:	SET '05-WELL1-COUNTER,4
	RETURN 50-WELL-BOTTOM

	.FUNCT SHORE-EXIT
	ICALL2 PERFORM,V?SWIM
	RFALSE
...
?L3:	PRINT MESSAGE-114
	...
	SET '16-TV-FLAG,0
	RTRUE
?L3:	EQUAL? P-NUMBER,1 \?L6
	ZERO? 16-TV-FLAG \?L6
	PRINT MESSAGE-068
	CRLF
	RTRUE
?L6:	EQUAL? P-NUMBER,2 \?L12
	ZERO? 16-TV-FLAG /?L9
	PRINT MESSAGE-068
	CRLF
	RTRUE
?L9:	EQUAL? P-NUMBER,2 \?L12
	ZERO? 16-TV-FLAG \?L12
	PRINT MESSAGE-066
	CRLF
	SET '16-TV-FLAG,1
	RTRUE
?L12:	EQUAL? PRSO,NUMBER \FALSE
	PRINTR "You don't see that here."

	.FUNCT BEDROOM-F,RARG
	EQUAL? RARG,M-BEG \?L12
	ZERO? 12-NEW-JERSEY-DOOR-FLAG \?L19
	ZERO? 13-BLANKET-ON-BRUCE-FLAG \?L3
	MOVE 34-SOUND,LOCAL-GLOBALS
	MOVE 35-MUFFLED-SOUND,HERE
	MOVE 15-OLD-MAN,HERE
	MOVE 16-OLD-MAN-SLEEPING,LOCAL-GLOBALS
	RFALSE
?L3:	ZERO? 12-NEW-JERSEY-DOOR-FLAG \?L19
	ZERO? 13-BLANKET-ON-BRUCE-FLAG /?L6
	MOVE 34-SOUND,LOCAL-GLOBALS
	MOVE 35-MUFFLED-SOUND,LOCAL-GLOBALS
	MOVE 15-OLD-MAN,LOCAL-GLOBALS
	MOVE 16-OLD-MAN-SLEEPING,HERE
	RFALSE
?L6:	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L12
?L19:	ZERO? 13-BLANKET-ON-BRUCE-FLAG \?L9
	MOVE 34-SOUND,HERE
	MOVE 35-MUFFLED-SOUND,LOCAL-GLOBALS
	MOVE 15-OLD-MAN,HERE
	MOVE 16-OLD-MAN-SLEEPING,LOCAL-GLOBALS
	RFALSE
?L9:	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L12
	ZERO? 13-BLANKET-ON-BRUCE-FLAG /?L12
	MOVE 34-SOUND,LOCAL-GLOBALS
	MOVE 35-MUFFLED-SOUND,HERE
	MOVE 15-OLD-MAN,HERE
	MOVE 16-OLD-MAN-SLEEPING,LOCAL-GLOBALS
...
?L12:	EQUAL? RARG,M-END \FALSE
	ZERO? 14-BRUCE-SPRINGSTEEN-FLAG \FALSE
	CRLF
	PRINT MESSAGE-047
	CRLF
	SET '14-BRUCE-SPRINGSTEEN-FLAG,1
	RTRUE

	.FUNCT BEDROOM-DOOR-F
	EQUAL? PRSA,V?OPEN \?L9
	ZERO? 12-NEW-JERSEY-DOOR-FLAG \?L31
	ZERO? 13-BLANKET-ON-BRUCE-FLAG \?L3
	PRINT MESSAGE-038
	CRLF
	MOVE 35-MUFFLED-SOUND,LOCAL-GLOBALS
	MOVE 34-SOUND,HERE
	SET '12-NEW-JERSEY-DOOR-FLAG,1
	RTRUE
?L3:	ZERO? 12-NEW-JERSEY-DOOR-FLAG \?L31
	ZERO? 13-BLANKET-ON-BRUCE-FLAG /?L6
	PRINT MESSAGE-039
	CRLF
	MOVE 35-MUFFLED-SOUND,HERE
	...
	SET '12-NEW-JERSEY-DOOR-FLAG,1
	RTRUE
?L6:	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L9
?L31:	PRINT MESSAGE-040
	CRLF
	RTRUE
?L9:	EQUAL? PRSA,V?CLOSE \?L21
	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L32
	ZERO? 13-BLANKET-ON-BRUCE-FLAG \?L15
	PRINT MESSAGE-042
	CRLF
	MOVE 35-MUFFLED-SOUND,HERE
	MOVE 34-SOUND,LOCAL-GLOBALS
	SET '12-NEW-JERSEY-DOOR-FLAG,0
	RTRUE
?L15:	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L32
	ZERO? 13-BLANKET-ON-BRUCE-FLAG /?L18
	PRINT MESSAGE-043
	CRLF
	MOVE 35-MUFFLED-SOUND,LOCAL-GLOBALS
	MOVE 16-OLD-MAN-SLEEPING,HERE
	...
	SET '12-NEW-JERSEY-DOOR-FLAG,0
	RTRUE
?L18:	ZERO? 12-NEW-JERSEY-DOOR-FLAG \?L21
?L32:	PRINT MESSAGE-044
	CRLF
	RTRUE
?L21:	EQUAL? PRSA,V?EXAMINE \FALSE
	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L27
	PRINT MESSAGE-037
	CRLF
	RTRUE
?L27:	PRINT MESSAGE-036
	CRLF
	RTRUE

	.FUNCT NEW-JERSEY-DOOR-F
	EQUAL? PRSA,V?OPEN \?L6
	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L25
	PRINT MESSAGE-040
	CRLF
	RTRUE
?L25:	PRINT MESSAGE-045
	CRLF
	SET '12-NEW-JERSEY-DOOR-FLAG,1
	RTRUE
?L6:	EQUAL? PRSA,V?CLOSE \?L15
	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L26
	PRINT MESSAGE-041
	CRLF
	SET '12-NEW-JERSEY-DOOR-FLAG,0
	RTRUE
?L26:	PRINT MESSAGE-044
	CRLF
	MOVE 35-MUFFLED-SOUND,LOCAL-GLOBALS
?L15:	EQUAL? PRSA,V?EXAMINE \FALSE
	ZERO? 12-NEW-JERSEY-DOOR-FLAG /?L21
	PRINT MESSAGE-037
	CRLF
	RTRUE
?L21:	PRINT MESSAGE-036
	CRLF
	RTRUE

	.FUNCT ROYAL-PUZZLE-ENTRANCE-EXIT
	LOC 36-SANDSTONE-BLOCK >STACK
	EQUAL? STACK,HERE /?L1
	RETURN 38-ROYAL-PUZZLE
?L1:	PRINT MESSAGE-078
	CRLF
	RFALSE

	.FUNCT CERISE-BUTTON-F
	EQUAL? PRSA,V?PUSH \?L1
	EQUAL? HERE,32-ELEVATOR-CERISE \?L1
	PRINT MESSAGE-068
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-084
	CRLF
	CRLF
	SET '22-ELEVATOR-FLAG,1
	...
	ICALL2 GOTO,32-ELEVATOR-CERISE
	RTRUE

	.FUNCT OCHRE-BUTTON-F
	EQUAL? PRSA,V?PUSH \?L1
	EQUAL? HERE,33-ELEVATOR-OCHRE \?L1
	PRINT MESSAGE-068
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-084
	...
	ICALL2 GOTO,33-ELEVATOR-OCHRE
	RTRUE

	.FUNCT PURPLE-BUTTON-F
	EQUAL? PRSA,V?PUSH \?L1
	EQUAL? HERE,34-ELEVATOR-PURPLE \?L1
	PRINT MESSAGE-068
	CRLF
	RTRUE
?L1:	PRINT MESSAGE-084
	...
	ICALL2 GOTO,34-ELEVATOR-PURPLE
	RTRUE

	.FUNCT FLOOR-F
	EQUAL? PRSA,V?SAW \?L3
	EQUAL? PRSI,14-SAW \?L3
	PRINT MESSAGE-086
	CRLF
	CRLF
	ICALL2 GOTO,37-PEDESTAL
	RTRUE
?L3:	CALL1 STANDARD-F >STACK
	RSTACK

	.FUNCT PEDESTAL-DOWN-F
	CALL2 JIGS-UP,MESSAGE-087 >STACK
	RSTACK
...
?L1:	CALL1 STANDARD-F >STACK
	...
	.FUNCT DANISH-BAKERY-F,RARG
	EQUAL? RARG,M-END \FALSE
	ZERO? 20-PREBEN-FLAG \FALSE
	CRLF
	PRINT MESSAGE-070
	CRLF
	SET '20-PREBEN-FLAG,1
	RTRUE

	.FUNCT TOADSTOOL-FLOOR-F
	EQUAL? PRSA,V?EXAMINE,V?SEARCH \?L1
	ZERO? 17-ZX-SPECTRUM-FLAG \?L1
	PRINT MESSAGE-048
	CRLF
	MOVE 05-ZX-SPECTRUM,HERE
	SET '17-ZX-SPECTRUM-FLAG,1
	ICALL2 THIS-IS-IT,05-ZX-SPECTRUM
	RTRUE
?L1:	CALL1 STANDARD-F >STACK
	RSTACK
	...
	ZERO? SCORE-PULL-LEVER-FLAG \?L3
	ADD SCORE,10 >SCORE
	SET 'SCORE-PULL-LEVER-FLAG,1
?L3:	ICALL2 JIGS-UP,MESSAGE-095
	RTRUE
?L1:	PRINT MESSAGE-068
	CRLF
	RTRUE

	.FUNCT WALL-F
	EQUAL? PRSA,V?PUSH \?L1
	EQUAL? HERE,39-ROYAL-PUZZLE \?L3
	PRINT MESSAGE-096
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-097
	CRLF
	RTRUE
?L1:	CALL1 STANDARD-F >STACK
	RSTACK
	...
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-030
	CRLF
	RTRUE
?L5:	EQUAL? PRSA,V?TOUCH \FALSE
	ZERO? 16-TV-FLAG /?L9
	PRINT MESSAGE-069
	CRLF
	CRLF
	SET '08-RAVINE-COUNTER,15
	ICALL2 GOTO,45-SOUTHERN-RAVINE
	RTRUE
?L9:	PRINT MESSAGE-069
	CRLF
	CRLF
	ICALL2 GOTO,42-DANISH-BAKERY
	RTRUE
...
?L1:	EQUAL? WINNER,PREBEN \FALSE
	...
	SET 'WINNER,PRSO
	RTRUE
?L1:	EQUAL? WINNER,JOHN-TAYLOR /?L6
	EQUAL? PRSO,JOHN-TAYLOR \FALSE
?L6:	EQUAL? PRSA,V?HELLO \?L7
	PRINT MESSAGE-063
	PRINTI " "
	PRINT MESSAGE-064
	CRLF
	...
	MOVE 30-ALBUM,HERE
	RTRUE
?L7:	EQUAL? WINNER,JOHN-TAYLOR \FALSE
	PRINTR "You are plainly ignored."

	.FUNCT SPOON-F
	EQUAL? PRSA,V?INSERT \?L9
	LOC 01-LARGE-ROCK >STACK
	EQUAL? STACK,HERE /?L3
	PUSH 0
	JUMP ?L4
?L3:	PUSH 1
?L4:	EQUAL? PRSI,0,STACK \?L5
	PRINTI "[in the large rock]"
	CRLF
	SET 'PRSI,01-LARGE-ROCK
	ZERO? SCORE-INSERT-SPOON-FLAG \?L5
	ADD SCORE,10 >SCORE
	SET 'SCORE-INSERT-SPOON-FLAG,1
?L5:	EQUAL? PRSA,V?INSERT \?L9
	EQUAL? PRSI,01-LARGE-ROCK \?L9
	ZERO? 11-STONE-DOOR-FLAG /?L11
	PRINT MESSAGE-035
	CRLF
	JUMP ?L13
?L11:	PRINT MESSAGE-034
	CRLF
?L13:	MOVE 01-LARGE-ROCK,LOCAL-GLOBALS
	MOVE 03-CHROME-SPOON,HERE
	FSET 03-CHROME-SPOON,NDESCBIT
	MOVE 02-LARGE-ROCK-WITH-SPOON,02-ROUND-ROOM
	SET '11-STONE-DOOR-FLAG,1
	RTRUE
?L9:	EQUAL? PRSA,V?TAKE \?L15
	LOC 02-LARGE-ROCK-WITH-SPOON >STACK
...
?L15:	EQUAL? PRSA,V?DROP \FALSE
	...
	.FUNCT SPECTRUM-F
	EQUAL? PRSA,V?CONNECT \?L1
	CALL2 HELD?,05-ZX-SPECTRUM >STACK
	ZERO? STACK /?L1
	EQUAL? HERE,24-LIVING-ROOM \?L1
	PRINT MESSAGE-098
	CRLF
	RTRUE
?L1:	EQUAL? PRSA,V?TAKE \FALSE
	ZERO? SCORE-ZX-SPECTRUM-FLAG \FALSE
	ADD SCORE,10 >SCORE
	SET 'SCORE-ZX-SPECTRUM-FLAG,1
	RFALSE
	...
	.FUNCT UNCONSCIOUS-THING-FISH-F
...
?L1:	EQUAL? PRSA,V?TAKE \?L4
	LOC 07-UNCONSCIOUS-THING-FISH >STACK
	EQUAL? STACK,HERE \?L4
	PRINT MESSAGE-005
	CRLF
	...
	ZERO? SCORE-PAPERBAG-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-PAPERBAG-FLAG,1
	RTRUE
?L4:	EQUAL? PRSA,V?WEAR \?L13
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L10
	FSET? PRSO,WORNBIT \?L10
	PRINT SYSMESSAGE-029
	CRLF
	RTRUE
?L10:	EQUAL? PRSA,V?WEAR \?L13
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L13
	FSET? PRSO,WORNBIT /?L13
	FSET? PRSO,NDESCBIT /?L13
	PRINT MESSAGE-009
	CRLF
	FSET 09-PAPERBAG,WORNBIT
	RTRUE
?L13:	EQUAL? PRSA,V?UNWEAR \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L16
	FSET? PRSO,WORNBIT \?L16
	EQUAL? HERE,19-FARMHOUSE \?L16
	FCLEAR 09-PAPERBAG,WORNBIT
	PRINT MESSAGE-062
	CRLF
	SET '07-PAPERBAG-COUNTER,0
	SET '19-FARMHOUSE-FLAG,0
	ICALL2 GOTO,20-OLD-FARM
	RTRUE
?L16:	EQUAL? PRSA,V?UNWEAR \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L19
	FSET? PRSO,WORNBIT /?L19
	PRINT SYSMESSAGE-023
	CRLF
	RTRUE
?L19:	EQUAL? PRSA,V?UNWEAR \FALSE
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /FALSE
...
?L1:	EQUAL? PRSA,V?TAKE \?L4
	LOC 18-COVERED-BRUCE-SPRINGSTEEN >STACK
	EQUAL? STACK,HERE \?L4
	...
	SET '13-BLANKET-ON-BRUCE-FLAG,0
	RTRUE
?L4:	EQUAL? PRSA,V?PUT-ON \FALSE
	EQUAL? PRSI,17-BRUCE-SPRINGSTEEN \?L7
	PRINT MESSAGE-046
	CRLF
	...
	SET '13-BLANKET-ON-BRUCE-FLAG,1
	RTRUE
?L7:	EQUAL? PRSA,V?PUT-ON \FALSE
	EQUAL? PRSI,12-EMPTY-CLOTHLINE \FALSE
	PRINT MESSAGE-102
	CRLF
	MOVE 11-BLANKET,HERE
	FSET 11-BLANKET,NDESCBIT
	...
	EQUAL? HERE,05-GREAT-HALL-NE \FALSE
	...
	.FUNCT OLD-MAN-SLEEPING-F
	EQUAL? PRSA,V?WAKE \FALSE
	CALL2 HELD?,05-ZX-SPECTRUM >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,08-BASKETBALL >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,09-PAPERBAG >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,26-YELLOW-STAMP >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,27-SALAMI >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,29-DANISH-PASTRY >STACK
	ZERO? STACK /?L3
	CALL2 HELD?,30-ALBUM >STACK
	ZERO? STACK /?L3
	PRINT MESSAGE-091
	CRLF
	CRLF
	...
	CRLF
	CRLF
	ICALL2 GOTO,47-CUBICAL-ROOM
	ZERO? SCORE-WAKE-MAN-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-WAKE-MAN-FLAG,1
	RTRUE
?L3:	PRINT MESSAGE-091
	CRLF
	CRLF
	PRINT MESSAGE-093
	CRLF
	CRLF
	ICALL2 GOTO,02-ROUND-ROOM
	ZERO? SCORE-WAKE-MAN-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-WAKE-MAN-FLAG,1
	RTRUE
...
?L1:	EQUAL? PRSA,V?DRINK \?L4
	...
	RTRUE
?L4:	EQUAL? PRSA,V?GIVE \?L11
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L11
	EQUAL? HERE,42-DANISH-BAKERY \?L11
	EQUAL? PRSI,PREBEN \?L11
	PRINT MESSAGE-074
	CRLF
	CRLF
	MOVE 20-DRINK,LOCAL-GLOBALS
	MOVE 29-DANISH-PASTRY,PLAYER
	ZERO? SCORE-DANISH-PASTRY-FLAG \?L13
	ADD SCORE,10 >SCORE
	SET 'SCORE-DANISH-PASTRY-FLAG,1
?L13:	ICALL2 GOTO,02-ROUND-ROOM
	RTRUE
?L11:	EQUAL? PRSA,V?EXAMINE \FALSE
	FSET? PRSO,NDESCBIT \FALSE
	PRINTR "You don't see that here."

	.FUNCT STONE-ON-PEDESTAL-F
	EQUAL? PRSA,V?TAKE \FALSE
	ICALL2 JIGS-UP,MESSAGE-008
	RTRUE

	.FUNCT STONE-F
	EQUAL? PRSA,V?TAKE \?L1
	MOVE 22-STONE-ON-PEDESTAL,LOCAL-GLOBALS
?L1:	EQUAL? PRSA,V?DROP \?L4
	EQUAL? HERE,37-PEDESTAL \?L4
	CALL2 HELD?,PRSO >STACK
	ZERO? STACK /?L4
	MOVE 22-STONE-ON-PEDESTAL,30-MUSEUM
	RFALSE
?L4:	EQUAL? PRSA,V?TOUCH-WITH \FALSE
	EQUAL? PRSO,23-STONE \FALSE
	EQUAL? PRSI,25-GREEN-STAMP \?L11
	PRINT MESSAGE-088
	CRLF
	MOVE 25-GREEN-STAMP,LOCAL-GLOBALS
	MOVE 26-YELLOW-STAMP,WINNER
	ZERO? SCORE-YELLOW-STAMP-FLAG \TRUE
	ADD SCORE,10 >SCORE
	SET 'SCORE-YELLOW-STAMP-FLAG,1
	RTRUE
?L11:	EQUAL? PRSI,26-YELLOW-STAMP \FALSE
	PRINT MESSAGE-089
	CRLF
	RTRUE
	...
	ZERO? 15-BOOK-FLAG /?L3
	PRINT MESSAGE-021
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-021
	CRLF
	CRLF
	PRINT MESSAGE-022
	CRLF
	...
	.FUNCT STAMP-F
	EQUAL? PRSA,V?TOUCH-WITH \?L1
	EQUAL? PRSI,23-STONE \?L1
	ICALL PERFORM,V?TOUCH-WITH,PRSI,PRSO
	RTRUE
?L1:	EQUAL? PRSA,V?TOUCH \?L4
	CALL2 HELD?,23-STONE >STACK
	ZERO? STACK /?L4
	PRINTI "[with the stone]"
	CRLF
	ICALL PERFORM,V?TOUCH-WITH,23-STONE,PRSO
	RTRUE
?L4:	EQUAL? PRSA,V?TOUCH,V?TOUCH-WITH \FALSE
	EQUAL? PRSO,25-GREEN-STAMP /?L9
	EQUAL? PRSO,26-YELLOW-STAMP \FALSE
?L9:	PRINT MESSAGE-090
	CRLF
	RTRUE
	...
	RTRUE
?L1:	EQUAL? PRSA,V?TAKE \FALSE
	ZERO? SCORE-SALAMI-FLAG \FALSE
	ADD SCORE,10 >SCORE
	SET 'SCORE-SALAMI-FLAG,1
	RFALSE

	.FUNCT DANISH-PASTRY-F
	...
	.FUNCT ALBUM-F
	EQUAL? PRSA,V?TAKE \FALSE
	ZERO? SCORE-ALBUM-FLAG \FALSE
	ADD SCORE,10 >SCORE
	SET 'SCORE-ALBUM-FLAG,1
	RFALSE

	.FUNCT RED-BUTTON-F
	EQUAL? PRSA,V?PUSH \FALSE
	CALL2 HELD?,32-DEVICE >STACK
	ZERO? STACK /FALSE
	ZERO? 21-DEVICE-FLAG /?L3
	PRINT MESSAGE-082
	CRLF
	RTRUE
?L3:	PRINT MESSAGE-081
	CRLF
	CRLF
	SET '21-DEVICE-FLAG,1
	ICALL MOVE-INVENTORY,PLAYER,02-ROUND-ROOM
	CALL2 GOTO,02-ROUND-ROOM >STACK
	RSTACK
...
?L6:	MOVE X,DST
	...
	.FUNCT LADDER-AGAINST-TOADSTOOL-F
	EQUAL? PRSA,V?TAKE \FALSE
	LOC 33-LADDER-AGAINST-TOADSTOOL >STACK
	EQUAL? STACK,HERE \FALSE
	...
	.FUNCT I-EVERY-TURN,?TMP
	EQUAL? HERE,19-FARMHOUSE \?L10
	FSET? 09-PAPERBAG,WORNBIT /?L1
	CRLF
	PRINT MESSAGE-059
	CRLF
	...
	ICALL2 GOTO,20-OLD-FARM
	RTRUE
?L1:	EQUAL? HERE,19-FARMHOUSE \?L10
	ZERO? 19-FARMHOUSE-FLAG /?L4
	CRLF
	PRINT MESSAGE-059
	CRLF
	CRLF
	ICALL2 GOTO,20-OLD-FARM
	RTRUE
?L4:	EQUAL? HERE,19-FARMHOUSE \?L10
	EQUAL? 07-PAPERBAG-COUNTER,5 \?L7
	CRLF
	PRINT MESSAGE-060
	CRLF
	SET '07-PAPERBAG-COUNTER,4
	RTRUE
?L7:	EQUAL? HERE,19-FARMHOUSE \?L10
	EQUAL? 07-PAPERBAG-COUNTER,1 \?L10
	CRLF
	PRINT MESSAGE-061
	CRLF
	CRLF
	...
	SET '19-FARMHOUSE-FLAG,1
	SET '07-PAPERBAG-COUNTER,0
	ZERO? SCORE-BASKETBALL-FLAG \?L12
	ADD SCORE,10 >SCORE
	SET 'SCORE-BASKETBALL-FLAG,1
?L12:	ICALL2 GOTO,20-OLD-FARM
	RTRUE
?L10:	EQUAL? 08-RAVINE-COUNTER,1 \?L16
	CRLF
	PRINT MESSAGE-076
	CRLF
	CRLF
	SET '08-RAVINE-COUNTER,0
	ICALL2 GOTO,02-ROUND-ROOM
	RTRUE
?L16:	EQUAL? 05-WELL1-COUNTER,3 \?L19
	CRLF
	PRINT MESSAGE-054
	CRLF
	SET '05-WELL1-COUNTER,2
	RTRUE
?L19:	EQUAL? 05-WELL1-COUNTER,2 \?L22
	CRLF
	PRINT MESSAGE-055
	CRLF
	SET '05-WELL1-COUNTER,1
	RTRUE
?L22:	EQUAL? 05-WELL1-COUNTER,1 \?L25
	CRLF
	PRINT MESSAGE-056
	CRLF
	CRLF
	MOVE 10-CLOTHLINE,LOCAL-GLOBALS
	LOC 11-BLANKET >STACK
	EQUAL? STACK,20-OLD-FARM \?L27
	FSET? 11-BLANKET,NDESCBIT \?L30
	ZERO? GAME$005fVERSION$005fCLASSIC \?L27
	FCLEAR 11-BLANKET,NDESCBIT
?L27:	FSET? 11-BLANKET,NDESCBIT \?L30
	MOVE 11-BLANKET,LOCAL-GLOBALS
?L30:	MOVE 12-EMPTY-CLOTHLINE,LOCAL-GLOBALS
	SET '05-WELL1-COUNTER,0
	SET '18-WELL-FLAG,1
	ICALL2 GOTO,20-OLD-FARM
	RTRUE
?L25:	EQUAL? 06-WELL2-COUNTER,1 \?L34
	CRLF
	PRINT MESSAGE-058
	CRLF
	SET '06-WELL2-COUNTER,0
	RTRUE
?L34:	ZERO? 05-WELL1-COUNTER /?L37
	DEC '05-WELL1-COUNTER
?L37:	ZERO? 06-WELL2-COUNTER /?L40
	DEC '06-WELL2-COUNTER
?L40:	ZERO? 07-PAPERBAG-COUNTER /?L43
	DEC '07-PAPERBAG-COUNTER
?L43:	ZERO? 08-RAVINE-COUNTER /?L46
	DEC '08-RAVINE-COUNTER
?L46:	RANDOM 100 >STACK
	GRTR? STACK,10 /?L49
	EQUAL? HERE,05-GREAT-HALL-NE,12-ON-TOADSTOOL \?L49
	CRLF
	PRINT MESSAGE-101
	CRLF
	RTRUE
?L49:	RANDOM 100 >STACK
	GRTR? STACK,5 /?L52
	LOC PLAYER >?TMP
	EQUAL? ?TMP,13-VERTEX,19-FARMHOUSE,25-BEDROOM /?L52
	EQUAL? ?TMP,47-CUBICAL-ROOM,50-WELL-BOTTOM /?L52
	CRLF
	CALL2 PICK-ONE-R,WIZARD-ACTION >STACK
	PRINT STACK
	CRLF
	CRLF
	PRINT MESSAGE-106
	CRLF
	RTRUE
?L52:	CALL2 HELD?,32-DEVICE >STACK
	ZERO? STACK /?L55
	MOVE RED-BUTTON,HERE
	RTRUE
?L55:	MOVE RED-BUTTON,LOCAL-GLOBALS
	RTRUE
